 ...
 */
#ifdef S2W_GSLINK
typedef struct S2W_HTTPD_CONTEXT
{
...
typedef struct S2W_CID
{
    ...
    S2W_TIMER_T s2wUserCloseTimer;
    UINT8 s2wUsrCloseFlag;
    UINT8 s2wSockDataPending;
	#ifdef S2W_GSLINK
	S2W_HTTPD_CONTEXT_T httpdCtx;	
	#ifdef S2W_GSLINK_XML
 ...
 ******************************************************************/
UINT8 AppS2wHal_NetUdpClient(S2W_NETDATA_T *peerData, UINT8 *cidp,UINT16 srcPort);
 ...
 * @retval S2W_ENCID       - operation failed- no valid cid
 ******************************************************************/
UINT8 AppS2wHal_NetTcpClient(S2W_NETDATA_T *peerData, UINT8 *cidNo);

UINT8 AppS2wHal_NetTcpClient_test(S2W_NETDATA_T *peerData, UINT8 *cidNo);
 ...
 * @retval S2W_ENCID       - operation failed- no valid cid
 ******************************************************************/
UINT8 AppS2wHal_NetUdpServer(S2W_NETDATA_T *serverData, UINT8 *cidp);
 ...
 * @retval S2W_ENCID       - operation failed- no valid cid
 ******************************************************************/
UINT8 AppS2wHal_NetTcpServer(S2W_NETDATA_T *serverData, UINT8 *cidp);


#ifdef S2W_IPv6_SUPPORT

UINT8 AppS2wHal_NetUdpClientv6(S2W_NETDATA_T *remoteServerData, UINT8 *cidNo, UINT16 srcPort);

UINT8 AppS2wHal_NetUdpServerv6(S2W_NETDATA_T *serverData, UINT8 *cidNo);

UINT8 AppS2wHal_NetTcpClientv6(S2W_NETDATA_T *remoteServerData, UINT8 *cidNo);

UINT8 AppS2wHal_NetTcpServerv6(S2W_NETDATA_T *serverData, UINT8 *cidNo);
